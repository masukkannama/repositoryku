...
// Tipe data baru untuk menyimpan URL m3u8 asli
type MediaItem = {
  id: string;
  title: string;
  thumb: string;
...
async function handler(req: Request) {
  ...
  // Menghapus blok kode yang menangani pengalihan (redirect)
  // dan proxy karena tidak lagi diperlukan.
...
// Fungsi ini sekarang melakukan fetch m3u8 untuk setiap video
async function getList(base: URL, pages = 3) {
  ...
  // Looping untuk mendapatkan m3u8 asli untuk setiap item
...
// Fungsi ini menggunakan URL m3u8 asli di playlist
