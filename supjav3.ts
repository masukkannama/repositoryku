...
async function handler(req: Request) {
  ...
  // Handle URL untuk mengambil file m3u8 dan TS dari Worker
  ...
  // Handle URL yang mengarahkan ke Worker untuk mem-proxy m3u8
  ...
  // Handle URL untuk membuat playlist M3U
